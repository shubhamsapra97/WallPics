...
(function(){
    ...
    // var chell = firebase.database().ref("imageCount/");
    //
    // chell.once('value').then(function(snapshot) {
    ...
    firebase.database().ref("imageCount/").once('value').then(function(snapshot) {
          var q = (Number)(snapshot.value);
         // imageCount = q;
         // if(imageCount>0){
         //   imageCount++;
